...
generate_gra_h5(filepattern,filein)
filectl=generate_ctl_h5(filepattern,filein)
...
function generate_gra_h5(filepattern,filein)
  say 'abrindo arquivo h5 'filein'...'
  'reinit'
  'open 'filein
  fileout=filepattern'gra'
  '!rm 'fileout
...
function generate_ctl_h5(filepattern,filein)
  say 'abrindo arquivo NETCDF 'filein'...'
  'open 'filein
  filectlout=filepattern'ctl'
  say 'tentando remover arquivo ctl 'filectlout'...'
